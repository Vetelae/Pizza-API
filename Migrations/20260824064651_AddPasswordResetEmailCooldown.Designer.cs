...
namespace Pizza_API.Migrations
{
    ...
    [Migration("20260824064651_AddPasswordResetEmailCooldown")]
    partial class AddPasswordResetEmailCooldown
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pizza_API.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FailedLoginWindowStartUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("failed_login_window_start_utc");
                    ...
                    b.Property<DateTimeOffset?>("LastLockoutAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_lockout_at_utc");
                    ...
                    b.Property<DateTimeOffset?>("LastPasswordResetEmailRequestUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_password_reset_email_request_utc");
            ...
            modelBuilder.Entity("Pizza_API.Entities.Order", b =>
                {
                    ...
                    b.HasIndex("ReadyAt")
                        .HasDatabaseName("ix_orders_ready_at")
